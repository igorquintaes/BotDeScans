...
public class GoogleDriveResourcesServiceTests : UnitTest, IDisposable
{
    ...
    public class GetResourcesAsync : GoogleDriveResourcesServiceTests
    {
        ...
        public async Task GivenMoreThanMaxExpectedFilesShouldReturnFailResult()
        {
            ...
            result.Should().BeFailure().And.HaveError($"Foi encontrado {files.Count} resultados para os dados mencionados, quando era esperado no máximo {maxResult}.");
        }
        ...
        public async Task GivenLessThanMinExpectedFilesShouldReturnFailResult()
        {
            ...
            result.Should().BeFailure().And.HaveError($"Foi encontrado {files.Count} resultados para os dados mencionados, quando era esperado no mínimo {minResult}.");
        }
